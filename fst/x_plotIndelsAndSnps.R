...
path_to_snps <- "C:/Users/miles_000/Downloads/Research/Tooth/results/x/x_snps.fst"
path_to_indels <- "C:/Users/miles_000/Downloads/Research/Tooth/results/x/x_indels.fst"
...
# Plot the data
image_name <- "UMD2a_Bicuspid_vs_Tricuspid_Zfst_Separated_X.png"
...
palette("default")
plot(total$ID, total$Zfst, col=as.numeric(as.character(total$LG)), xlab="Linkage Group", ylab=expression("Z"[fst]), xaxt="n", yaxt="n", bty="n", main="", pch=20, cex=0.60)
abline(h = 0)
title(main = expression("UMD2a Bicuspid vs Tricuspid Z"[fst]*" (No Pseudotropheus and Petrotilapia)"))
